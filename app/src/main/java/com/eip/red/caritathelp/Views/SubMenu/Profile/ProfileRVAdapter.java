...
/**
 * Created by pierr on 15/09/2016.
 */

public class ProfileRVAdapter extends RecyclerView.Adapter<ProfileRVAdapter.DataObjectHolder> {
    ...
    public ProfileRVAdapter(ProfilePresenter presenter) {
