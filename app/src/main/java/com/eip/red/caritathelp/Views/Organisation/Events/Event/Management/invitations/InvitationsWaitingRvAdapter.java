...
public class InvitationsWaitingRvAdapter extends RecyclerView.Adapter<InvitationsWaitingRvAdapter.ItemViewHolder> {

    private InvitationsPresenter presenter;
    private List<Guest> guests;

    public InvitationsWaitingRvAdapter(InvitationsPresenter presenter) {
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public void onClickYesBtn() {
            ...
            if (guest != null)
                presenter.join(guest.getNotifId(), true, getAdapterPosition());
        }
        ...
        public void onClickNoBtn() {
            ...
            if (guest != null)
                presenter.join(guest.getNotifId(), false, getAdapterPosition());
        }
    }
